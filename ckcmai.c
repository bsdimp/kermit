...
/* Edit History
 * +1	21 Jun 85 MM	Added initial call to hack_vms_open_console()
 *			so error messages can be ouput while parsing
 *			command arguments.  Frank will clean this up!
 */
...
#ifdef vms
    hack_vms_open_console();		/* Make sure error message routines */
